...
var routes = [
    ...
    },
    {
        ...
        loadChildren: function () { return __webpack_require__.e(/*! import() | package-details-package-details-module */ "package-details-package-details-module").then(__webpack_require__.bind(null, /*! ./package-details/package-details.module */ "./src/app/travel-package/package-details/package-details.module.ts")).then(function (m) { return m.PackageDetailsPageModule; }); }
    }
];
var TravelPackagePageRoutingModule = /** @class */ (function () {
    function TravelPackagePageRoutingModule() {
    }
    ...
    return TravelPackagePageRoutingModule;
}());
...
var TravelPackagePageModule = /** @class */ (function () {
    function TravelPackagePageModule() {
    }
    ...
    return TravelPackagePageModule;
}());
...
var TravelPackagePage = /** @class */ (function () {
    function TravelPackagePage(packageService, vibration, photoViewer) {
        this.packageService = packageService;
        this.vibration = vibration;
        this.photoViewer = photoViewer;
    }
    TravelPackagePage.prototype.ngOnInit = function () {
        this.getPackageData();
    };
    TravelPackagePage.prototype.viewImageInFull = function (event) {
        console.log(event);
        this.photoViewer.show("packagelist.image", "Image in big screen", { share: true });
    };
    TravelPackagePage.prototype.ShowMe = function () {
        this.vibration.vibrate(2000);
    };
    TravelPackagePage.prototype.getPackageData = function () {
        var _this = this;
        this.packageService.getPackages().subscribe(function (data) {
            _this.packagelists = data;
            console.log(_this.packagelists);
        }, function (err) { return console.log(err); }, function () { return console.log('Packages loaded'); });
    };
    TravelPackagePage.ctorParameters = function () { return [
...
//# sourceMappingURL=travel-package-travel-package-module-es5.js.map